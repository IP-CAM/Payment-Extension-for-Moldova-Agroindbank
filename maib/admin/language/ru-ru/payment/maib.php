...
// SameSite Cookies
$_['entry_fix_cookies_label'] = 'Временное решение для потери сеанса';
$_['entry_fix_cookies'] = 'Если атрибут SameSite cookie имеет значение Lax или Strict, они не отправляются в межсайтовом запросе.<br>Такое поведение защищает пользовательские данные от случайной утечки третьим лицам и подделки межсайтовых запросов.<br>Из-за такого поведения при возвращении с сайта банка после успешной оплаты сеанс пользователя теряется.<br>Чтобы устранить эту проблему, установите для параметра <i>SameSite</i> значение <b>None</b>. (<b>Система &raquo; Настройки &raquo; Редактировать магазин &raquo; Сервер &raquo; Session Samesite Cookie</b>).<br>Обратите внимание, что это будет работать, только если используется <i>https</i>.';
