...
$_['error_no_currency'] = 'Only following currency codes are supported: EUR, MDL.';
$_['error_no_transaction_id'] = 'Unable to register payment transaction. Try again or use another payment method for the order.';
